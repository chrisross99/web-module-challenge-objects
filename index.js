...
createMenuItem(macAndCheese, 10, dinner);
...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function (discountTitle) 
}

{
  let discountTotal = burger.price;
  if (discountTitle === 'public')
  {
    return discountTotal * .90;
  } else {
    return discountTotal * .75;
  }
}
